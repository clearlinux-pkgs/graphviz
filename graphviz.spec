...
Source0  : https://gitlab.com/graphviz/graphviz/-/archive/12.1.1/graphviz-12.1.1.tar.gz
...
%prep
%setup -q -n graphviz-12.1.1
cd %{_builddir}/graphviz-12.1.1
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a graphviz-12.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726068705
mkdir -p clr-build
pushd clr-build
